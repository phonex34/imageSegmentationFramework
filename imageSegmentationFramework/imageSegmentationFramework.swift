//
//  imageSegmentationFramework.swift
//  "${PODS_ROOT}/TensorFlowLiteC/Frameworks"
//
//  Created by AI on 10/19/20.
//
...
public class ImageSegmentation {
    ...
    public var hello: String = "zoooo"
    public let number: Int = 10
    public var number2: Int = 100
    public var number3: Int = 1000
...
//    }
    ...
    public func loadLabelList() -> [String]? {
      guard
    ...
    public func newInstance(completion: @escaping ((Result<ImageSegmentation>) -> Void)) {
      ...
      tfLiteQueue.async {
        ...
        guard let labelList = self.loadLabelList() else {
          print(
        ...
        do {
          ...
          // Create an FrameworkImageSegmentator instance and return.
          let segmentator = ImageSegmentation(
    ...
    func runSegmentation(
      ...
      tfLiteQueue.async {
        ...
        guard
          let resultImage = ImageSegmentation.imageFromSRGBColorArray(
